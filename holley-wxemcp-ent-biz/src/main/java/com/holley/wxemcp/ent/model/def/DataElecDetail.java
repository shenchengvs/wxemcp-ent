...
public class DataElecDetail {
	...
	// 往月
	private BigDecimal ddFee;
	private BigDecimal jbFee;
	private BigDecimal jjFee;
	private BigDecimal llFee;
	...
	private List<DetailElecVo> datas;
	...
	public BigDecimal getDdFee() {
		return ddFee == null ? ddFee : ddFee.setScale(2);
	}

	public void setDdFee(BigDecimal ddFee) {
		this.ddFee = ddFee;
	}

	public BigDecimal getJbFee() {
		return jbFee == null ? jbFee : jbFee.setScale(2);
	}

	public void setJbFee(BigDecimal jbFee) {
		this.jbFee = jbFee;
	}

	public BigDecimal getJjFee() {
		return jjFee == null ? jjFee : jjFee.setScale(2);
	}

	public void setJjFee(BigDecimal jjFee) {
		this.jjFee = jjFee;
	}

	public BigDecimal getLlFee() {
		return llFee == null ? llFee : llFee.setScale(2);
	}

	public void setLlFee(BigDecimal llFee) {
		this.llFee = llFee;
	}
	...
	public List<DetailElecVo> getDatas() {
		return datas;
	}

	public void setDatas(List<DetailElecVo> datas) {
		this.datas = datas;
	}
