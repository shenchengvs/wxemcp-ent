...
<script>
getStorage('data/initPowePage.action');
</script>
</head>
<body ontouchstart>
...
<div class="weui-tabbar">
    ...
    <a href="data/initPowePage.action" class="weui-tabbar__item weui-bar__item--on">
        <div class="weui-tabbar__icon">
...
<script src="<%=request.getContextPath()%>/res/data/tab_electricQtySearch.js?v=${version}"></script>
