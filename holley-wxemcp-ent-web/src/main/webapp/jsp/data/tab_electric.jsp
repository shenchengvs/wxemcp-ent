...
<script>
getStorage('data/initRealPowerPage.action');
</script>
</head>
<body ontouchstart>
...
<div class="weui-tabbar weui-tabbar-1 hidden">
    <a href="data/initRealPowerPage.action" class="weui-tabbar__item weui-bar__item--on">
        <div class="weui-tabbar__icon">
            <img src="res/images/real_ele_active.png" alt="">
        </div>
...
<script src="<%=request.getContextPath()%>/res/data/tab_electric.js?v=${version}"></script>
